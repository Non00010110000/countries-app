...
const Countries = ({searchQuery,search}) => {
   const countriesData = [
    {
      "name": "Afghanistan",
      "topLevelDomain": [".af"],
          ...
          <div className='countries'>
            {search 
              ? countriesData
                  ...
                  .map((country, index) => (
                    <div onClick={()=> setShowDetails(!showDetails)} key={index} className={!isDark ? "div-white" : "div"}>
                      <img
                        className='img-flag'
                        src={country.flags.png}
                        alt={country.name}
                      />
                      <h3 className={isDark ? "h3-dark" : "h3-white"}>{country.name}</h3>
                      <div className='div-bla'>
